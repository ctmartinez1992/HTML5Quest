module Game3 {
    ...
    export class Level2 extends Phaser.State {
        ...
        static ENEMIES_SPEED: number = 1800;
        static PLAYER_BULLET_SPEED: number = 380;
        static PLAYER_BULLET_FREQUENCY: number = 220;
        static ENEMY_BULLET_SPEED: number = 220;
        static ENEMY_BULLET_FREQUENCY: number = 1800;
        ...
        createEnemies() {
            ...
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ x: 200 }, Level2.ENEMIES_SPEED, Phaser.Easing.Linear.None, true, 0, true, true);
            tween.onComplete.add(this.moveEnemiesDown, this);
        }

        moveEnemiesDown() {
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ y: this.enemies.y + 20 }, Level2.ENEMIES_SPEED / 4, Phaser.Easing.Linear.None, true, 0);
