module Game3 {
    ...
    export class Level1 extends Phaser.State {
        ...
        static PLAYER_BULLET_SPEED: number = 400;
        static PLAYER_BULLET_FREQUENCY: number = 200;
        static ENEMY_BULLET_SPEED: number = 200;
        static ENEMY_BULLET_FREQUENCY: number = 2000;
        ...
        createEnemies() {
            ...
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ x: 200 }, Level1.ENEMIES_SPEED, Phaser.Easing.Linear.None, true, 0, true, true);
            tween.onComplete.add(this.moveEnemiesDown, this);
        }

        moveEnemiesDown() {
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ y: this.enemies.y + 20 }, Level1.ENEMIES_SPEED / 4, Phaser.Easing.Linear.None, true, 0);
