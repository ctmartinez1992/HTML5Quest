module Game3 {
    ...
    export class Level10 extends Phaser.State {

        static SPAWN_ROW: number = 1;
        static SPAWN_COLUMN: number = 1;
        static MAX_LIVES: number = 1;
        static ENEMIES_SPEED: number = 1250;
        static PLAYER_BULLET_SPEED: number = 150;
        static PLAYER_BULLET_FREQUENCY: number = 150;
        static ENEMY_BULLET_SPEED: number = 400;
        static ENEMY_BULLET_FREQUENCY: number = 300;
        ...
        createEnemies() {
            ...
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ x: 200 }, Level10.ENEMIES_SPEED, Phaser.Easing.Linear.None, true, 0, true, true);
            tween.onComplete.add(this.moveEnemiesDown, this);
        }

        moveEnemiesDown() {
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ y: this.enemies.y + 20 }, Level10.ENEMIES_SPEED / 4, Phaser.Easing.Linear.None, true, 0);
