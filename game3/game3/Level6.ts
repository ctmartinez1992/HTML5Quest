module Game3 {
    ...
    export class Level6 extends Phaser.State {
        ...
        createEnemies() {
            ...
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ x: 200 }, Level6.ENEMIES_SPEED, Phaser.Easing.Linear.None, true, 0, true, true);
            tween.onComplete.add(this.moveEnemiesDown, this);
        }

        moveEnemiesDown() {
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ y: this.enemies.y + 20 }, Level6.ENEMIES_SPEED / 4, Phaser.Easing.Linear.None, true, 0);
