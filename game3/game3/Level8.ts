module Game3 {
    ...
    export class Level8 extends Phaser.State {

        static SPAWN_ROW: number = 16;
        static SPAWN_COLUMN: number = 4;
        ...
        static ENEMY_BULLET_FREQUENCY: number = 400;
        ...
        createEnemies() {
            ...
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ x: 200 }, Level8.ENEMIES_SPEED, Phaser.Easing.Linear.None, true, 0, true, true);
            tween.onComplete.add(this.moveEnemiesDown, this);
        }

        moveEnemiesDown() {
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ y: this.enemies.y + 20 }, Level8.ENEMIES_SPEED / 4, Phaser.Easing.Linear.None, true, 0);
