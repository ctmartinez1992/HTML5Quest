module Game3 {
    ...
    export class Level3 extends Phaser.State {
        ...
        static ENEMIES_SPEED: number = 1600;
        static PLAYER_BULLET_SPEED: number = 360;
        static PLAYER_BULLET_FREQUENCY: number = 240;
        static ENEMY_BULLET_SPEED: number = 240;
        static ENEMY_BULLET_FREQUENCY: number = 1600;
        ...
        createEnemies() {
            ...
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ x: 200 }, Level3.ENEMIES_SPEED, Phaser.Easing.Linear.None, true, 0, true, true);
            tween.onComplete.add(this.moveEnemiesDown, this);
        }

        moveEnemiesDown() {
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ y: this.enemies.y + 20 }, Level3.ENEMIES_SPEED / 4, Phaser.Easing.Linear.None, true, 0);
