module Game3 {
    ...
    export class Level5 extends Phaser.State {
        ...
        static SPAWN_ROW: number = 16;
        static SPAWN_COLUMN: number = 3;
        static MAX_LIVES: number = 2;
        static ENEMIES_SPEED: number = 1200;
        static PLAYER_BULLET_SPEED: number = 320;
        static PLAYER_BULLET_FREQUENCY: number = 280;
        static ENEMY_BULLET_SPEED: number = 280;
        static ENEMY_BULLET_FREQUENCY: number = 1200;
        ...
        createEnemies() {
            ...
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ x: 200 }, Level5.ENEMIES_SPEED, Phaser.Easing.Linear.None, true, 0, true, true);
            tween.onComplete.add(this.moveEnemiesDown, this);
        }

        moveEnemiesDown() {
            var tween: Phaser.Tween = this.add.tween(this.enemies).to({ y: this.enemies.y + 20 }, Level5.ENEMIES_SPEED / 4, Phaser.Easing.Linear.None, true, 0);
