Game12.GameOver = function (game) {
    this.game = game;
};

Game12.GameOver.prototype = {
	create: function () {
        this.sound.stopAll();
        ...
        this.textInst = game.add.text(game.camera.width / 2, game.camera.height / 2 + 50, "YOU GOT THE 7 COINS", { font: "18px Chunk", fill: "#ffffff", align: "center" });
