...
Game12.MainMenu.prototype = {
	create: function () {
        ...
        this.textInst = game.add.text(game.camera.width / 2, game.camera.height / 2 - 60, "CLICK TO SMITE", { font: "16px Chunk", fill: "#ffffff", align: "center" });
        ...
        this.textInst2 = game.add.text(game.camera.width / 2, game.camera.height / 2, "DESTROY ALL BOXES", { font: "16px Chunk", fill: "#ffffff", align: "center" });
        ...
        this.textInst3 = game.add.text(game.camera.width / 2, game.camera.height / 2 + 60, "", { font: "24px Chunk", fill: "#ff3618", align: "center" });
