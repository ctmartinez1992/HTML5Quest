Game15.MainMenu = function (game) {
    this.game = game;
    this.game.highscore = 0;
};
	

Game15.MainMenu.prototype = {
	create: function () {
        this.sound.stopAll();
        ...
        this.textInst = game.add.text(game.camera.width / 2, game.camera.height / 2 - 60, "ARROWS TO CONTROL THE MAN", { font: "16px Chunk", fill: "#ffffff", align: "center" });
