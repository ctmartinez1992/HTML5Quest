Game13.GameWin = function (game) {
    this.game = game;
};

Game13.GameWin.prototype = {
	create: function () {
        this.sound.stopAll();
        ...
        this.textInst = game.add.text(game.camera.width / 2, game.camera.height / 2 + 50, "YOU WON WITH " + Game13.score + " POINTS", { font: "18px Chunk", fill: "#ffffff", align: "center" });
