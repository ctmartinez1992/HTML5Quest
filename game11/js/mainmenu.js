...
Game11.MainMenu.prototype = {
	create: function () {
        ...
        this.textTitle = game.add.text(game.camera.width / 2, game.camera.height / 2 - 200, "ACID TRIP", { font: "28px Chunk", fill: "#ffffff", align: "center" });
        this.textTitle.anchor.setTo(0.5, 0.5);
		this.textTitle.alpha = 1;
		
        this.textInst = game.add.text(game.camera.width / 2, game.camera.height / 2 - 60, "ARROWS TO MOVE AND JUMP", { font: "16px Chunk", fill: "#ffffff", align: "center" });
        ...
        this.textInst2 = game.add.text(game.camera.width / 2, game.camera.height / 2, "FIND AND GET 7 COINS", { font: "16px Chunk", fill: "#ffffff", align: "center" });
        ...
        this.textInst3 = game.add.text(game.camera.width / 2, game.camera.height / 2 + 60, "WARNING: STRONG COLOR VARIATIONS___BEWARE", { font: "24px Chunk", fill: "#ff3618", align: "center" });
