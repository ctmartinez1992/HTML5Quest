module Game1 {
    ...
    export class LevelHard extends Phaser.State {

        PLAYER_SPEED: number = 1.5;
        ENEMY_SPEED: number = 2;
        BALL_SPEED: number = 7;
        ...
        create() {
            ...
            this.enemy = new Enemy(this.game, this.lateralTop, this.lateralBot, 750, this.world.centerY, this.ENEMY_SPEED);
