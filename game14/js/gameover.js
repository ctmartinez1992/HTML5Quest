Game14.GameOver = function (game) {
    this.game = game;
};

Game14.GameOver.prototype = {
	create: function () {
        this.sound.stopAll();
        ...
        this.textInst = game.add.text(game.camera.width / 2, game.camera.height / 2 + 50, "YOU DID NOT GET TO WORK ON TIME", { font: "18px Chunk", fill: "#ffffff", align: "center" });
